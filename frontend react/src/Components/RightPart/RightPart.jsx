  ...
  return (
    <div className="py-5 sticky top-0 overflow-y-hidden">
      <div className="hideScrollbar overflow-y-scroll">
        ...
        >
          <h1 className="text-xl font-bold">Get Verified on Admiree</h1>
          <h1 className="font-bold my-2">Subscribe to unlock new features</h1>
          <Button
            onClick={handleOpenSubscriptionModal}
            variant="contained"
            sx={{ padding: "10px", paddingX: "20px", borderRadius: "25px", bgcolor:'#e91e63' }}
          >
            {" "}
            Get verified
          </Button>
        ...
        >
          ...
          <a
            href="https://twitter.com/search?q=FIFA%20Women%27s%20World%20Cup&src=typed_query&f=live"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://twitter.com/hashtag/TheMarvels"
            target="_blank"
            rel="noreferrer"
          ...
          <div className="flex justify-between w-full">
            <a
              href="https://www.instagram.com/explore/tags/themarvels/"
              target="_blank"
              rel="noreferrer"
              className="flex justify-between w-full hover:underline"
            >
          ...
          <a
            href="https://twitter.com/search?q=%23TheMarvels&src=typed_query"
            target="_blank"
            rel="noreferrer"
            className="flex justify-between w-full hover:underline"
          >
