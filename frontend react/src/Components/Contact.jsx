  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <section className="grid md:grid-cols-3 gap-6 mb-10">
        <TeamMember name="Navi" role="Product Lead" img="https://i.pravatar.cc/150?img=12" />
        <TeamMember name="Devi" role="Fullstack Developer" img="https://i.pravatar.cc/150?img=32" />
        <TeamMember name="Yashitha" role="Designer" img="https://i.pravatar.cc/150?img=47" />
      </section>
