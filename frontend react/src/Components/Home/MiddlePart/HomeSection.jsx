...
const HomeSection = () => {
  ...
  const handleLocationClick = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (pos) => {
        ...
        setLocationAttached(loc);
        // attach to formik so backend receives it
  ...
  return (
    <div className="space-y-5">
      <section>
        <h1 className="py-5 text-xl font-bold opacity-90">Admiree</h1>
      </section>
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="flex justify-between items-center mt-5">
                <div className="flex space-x-5 items-center">
                  ...
                  <FmdGoodIcon onClick={handleLocationClick} className={`cursor-pointer ${locationAttached? 'text-green-400':'text-[#1d9bf0]'}`} />
                  ...
                  {locationAttached && (
                    <div className="text-sm ml-3 text-green-300">Location attached</div>
                  )}
                </div>
